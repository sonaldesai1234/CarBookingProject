...
import com.mycipl.service.dto.PasswordChangeDTO;
import com.mycipl.service.dto.UserDTO;
import com.mycipl.web.rest.errors.*;
import com.mycipl.web.rest.vm.KeyAndPasswordVM;
import com.mycipl.web.rest.vm.ManagedUserVM;
...
public class AccountResource {
    ...
    *//**
    ...
    public void saveAccount(@Valid @RequestBody UserDTO userDTO) {
        ...
        if (existingUser.isPresent() && (!existingUser.get().getDseLoginId().equalsIgnoreCase(userLogin))) {
            throw new EmailAlreadyUsedException();
        }
        Optional<User> user = userRepository.findOneByDseLoginId(userLogin);
        if (!user.isPresent()) {
...
*/
   ...
   CustomResponse customResponse=new CustomResponse();
       ...
       customResponse.setMessage("Password change successfully...");
